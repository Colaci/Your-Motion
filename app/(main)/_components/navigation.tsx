"use client"
// this navigation file includes the left sidebar and the top navigation bar
...
export const Navigation =() => {
  ...
  const resetWidth = () => {
    if(sidebarRef.current && navbarRef.current){
      ...
      // when isResetting is set true, the animation will be trigured and we use setTimeout to avoid the animation applied on drag event
      setIsResetting(true)
